var controlador_tareas = new Vue({
    ...
    methods: {
       recuperarEstados: function(){
          this.$http.get('index.php/Tareas_ajax/recuperar_estados').then(function(respuesta){
       ...
       recuperarTareas: function(){
          ...
          this.$http.get('index.php/Tareas_ajax/recuperar_tareas').then(function(respuesta){
       ...
       crearTarea: function(){
          this.$http.post('index.php/Tareas_ajax/crear_tarea', this.tarea_nueva).then(function(){
       ...
       modificarTarea: function(p_tarea){
          this.$http.post('index.php/Tareas_ajax/modificar_tarea', p_tarea).then(function(){
             this.recuperarTareas();
          }, function(){
       ...
       eliminarTarea: function(p_tarea){
          this.$http.post('index.php/Tareas_ajax/eliminar_tarea', p_tarea).then(function(){
             this.recuperarTareas();
          }, function(){
